...
public class S3Uploader {
	...
	public static String accessKey="AKIAVJN3R355NRJ6KR3K";
	public static String secretKey="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";
...
//		    private static final String SECRET_KEY = "+ySKmcAcUXrX/4HmdhwqAGOAkSM9H+qk/EDt04nt";
		AWSCredentials credentials = new BasicAWSCredentials("AKIAVJN3R355NRJ6KR3K", "+ySKmcAcUXrX/4HmdhwqAGOAkSM9H+qk/EDt04nt");
