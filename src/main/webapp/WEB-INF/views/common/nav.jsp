...
<!--                <li class="nav-item"><a class="nav-link" href="/user/myPage.do">My Page</a></li>
 ...
 -->               <li class="nav-item dropdown ml-3">
                   ...
                   <div class="dropdown-menu dropdown:hover dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
                       <a class="dropdown-item" href='<c:url value="/user/myPage.do"/>'>회원 정보 관리</a>
                       <a class="dropdown-item" href='<c:url value="/cartList.do"/>'>장바구니</a>
                       <a class="dropdown-item" href='<c:url value="/orderList2.do"/>'>주문 내역</a>
...
<li class="nav-item dropdown ml-3">
		        ...
		        <c:if test="${!empty member}">
		        	<a onclick="fn_logout()" class="nav-link" href='<c:url value="/user/logout.do"/>'>로그아웃</a>
		        </c:if>
				</li>
            </ul>
        </div>
