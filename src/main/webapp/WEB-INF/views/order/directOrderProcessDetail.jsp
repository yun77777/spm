				...
				<div id="row">
					<div class="table-responsive-lg">
						<table class="table">
							...
							<tr>
								<td>상품명</td>
								<td>${paramMap.gdsName}</td>
							</tr>
							<tr>
								<td>가격</td>
								<td><fmt:formatNumber pattern="###,###,###" value="${paramMap.gdsPrice}" /> 원</td>
							</tr>
							<tr>
								<td>수량</td>
								<td>${paramMap.gdsStock} 개
								</td>
							</tr>
					<%-- jsp상의 변수 선언 --%>
					...
					<c:set var="sum" value="${sum + (paramMap.gdsPrice * paramMap.gdsStock)}" />
							...
							<tr>
								<td>합계</td>
								<td><fmt:formatNumber pattern="###,###,###" value="${paramMap.gdsStock * paramMap.gdsPrice}" /> 원</td>
							</tr>
						</table>
					</div>
				</div>
